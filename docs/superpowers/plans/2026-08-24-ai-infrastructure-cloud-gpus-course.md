# AI Infrastructure Cloud GPUs Course Implementation Plan

> **For agentic workers:** REQUIRED SUB-SKILL: Use superpowers:subagent-driven-development (recommended) or superpowers:executing-plans to implement this plan task-by-task. Steps use checkbox (`- [ ]`) syntax for tracking.

**Goal:** Publish AI Infrastructure: Cloud GPUs as the eighth ACE single-page course.

**Architecture:** Add a new AI Infrastructure course-series directory and reuse the current MkDocs presentation. Normalize headings only outside fenced code blocks so shell comments remain source content.
...
- Create: `tests/fixtures/ACE_AI_Infrastructure_Cloud_GPUs.source.txt`

**Interfaces:**
- Consumes: the 586-line UTF-8 supplied source.
...
**Files:**
- Create: `docs/courses/ace/ai-infrastructure/ai-infrastructure-cloud-gpus.md`
- Modify: `mkdocs.yml`
...
- Produces: one Cloud GPUs page reachable from all discovery surfaces after Google Cloud Databases.

- [ ] Transform only headings outside fenced code and preserve every code comment.
- [ ] Add the AI Infrastructure child entry, eighth homepage rail/card, and eighth learning-path course.
...
- [ ] Commit with `feat: add AI Infrastructure Cloud GPUs course notes` and push `main`.

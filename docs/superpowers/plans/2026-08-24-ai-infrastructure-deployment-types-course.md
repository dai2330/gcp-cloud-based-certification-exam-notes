# AI Infrastructure Deployment Types Course Implementation Plan

> **For agentic workers:** REQUIRED SUB-SKILL: Use superpowers:subagent-driven-development (recommended) or superpowers:executing-plans to implement this plan task-by-task. Steps use checkbox (`- [ ]`) syntax for tracking.

**Goal:** Publish AI Infrastructure: Deployment Types as the tenth ACE single-page course.

**Architecture:** Add a third page to the existing AI Infrastructure course-series directory and reuse the current MkDocs presentation. Normalize headings only outside fenced code blocks so shell comments remain source content.
...
- Create: `tests/fixtures/ACE_AI_Infrastructure_Deployment_Types.source.txt`

**Interfaces:**
- Consumes: the 633-line UTF-8 supplied source.
...
**Files:**
- Create: `docs/courses/ace/ai-infrastructure/ai-infrastructure-deployment-types.md`
- Modify: `mkdocs.yml`
...
- Produces: one Deployment Types page reachable from all discovery surfaces after Cloud TPUs.

- [ ] Transform only headings outside fenced code and preserve every code comment.
- [ ] Add the Deployment Types child entry, tenth homepage rail/card, and tenth learning-path course.
...
- [ ] Commit with `feat: add AI Infrastructure Deployment Types course notes` and push `main`.
